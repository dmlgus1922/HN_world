...
const Map1 = () => {
  ...
  function getListItem(index, places) {
    ...
    //   if (places.road_address_name) {
    //     document.getElementById('start').value = places.road_address_name;
    //     // console.log(places.road_address_name);
    //     // console.log(document.getElementById('start').value)
    //   } else {
    //     document.getElementById('start').value = places.address_name;
    ...
    <>
      ...
      <Dialog open={open} onClose={handleClose} fullScreen TransitionComponent={Transition}>
        ...
        <div id="menu_wrap" class="bg_white">
          <div id="map" style={{ width: "100%", height: "50%", position: "relative", overflow: "hidden" }}>
          </div>

          <div class="option">
            <div>
              <button onClick={handleClose}> 닫기 </button>
              키워드 : <input type="text" id="keyword" onChange={changeKeyword} size="15" />
